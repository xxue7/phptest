...
class SaeTClientV2 {
	 ...
	 * @return array
	 */
	function publicTimeline($page = 1, $count = 50, $base_app = 0) {
		$params = array();
	 ...
	 * @return array
	 */
	function homeTimeline($page = 1, $count = 50, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0) {
		$params = array();
		if ($since_id) {
			$this->idFormat($since_id);
			$params['since_id'] = $since_id;
		}
		if ($max_id) {
			$this->idFormat($max_id);
	 ...
	 * @return array
	 */
	function friendsTimeline($page = 1, $count = 50, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0) {
		return $this->homeTimeline($since_id, $max_id, $count, $page, $base_app, $feature);
	}
	 ...
	 * @return array
	 */
	function userTimelineById($uid = NULL, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0) {
		$params = array();
		$params['uid'] = $uid;
		if ($since_id) {
			$this->idFormat($since_id);
	 ...
	 * @return array
	 */
	function userTimelineByName($screen_name = NULL, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0) {
		$params = array();
	 ...
	 * @return array
	 */
	function timelineBatchByName($screen_name, $page = 1, $count = 50, $feature = 0, $base_app = 0) {
		$params = array();
	 ...
	 * @return array
	 */
	function timelineBatchById($uids, $page = 1, $count = 50, $feature = 0, $base_app = 0) {
		$params = array();
		if (is_array($uids) && !empty($uids)) {
			foreach ($uids as $k => $v) {
				$this->idFormat($uids[$k]);
			}
	 ...
	 * @return array
	 */
	function repostTimeline($sid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0) {
		$this->idFormat($sid);
		...
		return $this->requestWithPager('statuses/repost_timeline', $page, $count, $params);
	}
	 ...
	 * @return array
	 */
	function repostByMe($page = 1, $count = 50, $since_id = 0, $max_id = 0) {
		$params = array();
		if ($since_id) {
			$this->idFormat($since_id);
			$params['since_id'] = $since_id;
		...
		return $this->requestWithPager('statuses/repost_by_me', $page, $count, $params);
	}
	...
	function mentions($page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0, $filter_by_type = 0) {
		...
		return $this->requestWithPager('statuses/mentions', $page, $count, $params);
	}
	 ...
	 * @return array
	 */
	function repostDaily($count = 20, $base_app = 0) {
		$params = array();
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
	 ...
	 * @return array
	 */
	function repostWeekly($count = 20, $base_app = 0) {
		$params = array();
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
	 ...
	 * @return array
	 */
	function commentsDaily($count = 20, $base_app = 0) {
		$params = array();
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
	 ...
	 * @return array
	 */
	function commentsWeekly($count = 20, $base_app = 0) {
		$params = array();
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
	 ...
	 * @return array
	 */
	function uploadUrlText($status, $url, $visible = 0, $list_id = NULL, $pic_id = NULL, $lat = NULL, $long = NULL, $annotations = NULL) {
		$params = array();
		$params['status'] = $status;
		$params['url'] = $url;
		$params['visible'] = $visible;
	 ...
	 * @return array
	 */
	function getCommentsBySid($sid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0) {
		$params = array();
		$this->idFormat($sid);
		$params['id'] = $sid;
		if ($since_id) {
	 ...
	 * @return array
	 */
	function commentsByMe($page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_source = 0) {
		$params = array();
		if ($since_id) {
			$this->idFormat($since_id);
			$params['since_id'] = $since_id;
	 ...
	 * @return array
	 */
	function commentsToMe($page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0) {
		$params = array();
		if ($since_id) {
			$this->idFormat($since_id);
			$params['since_id'] = $since_id;
	 ...
	 * @return array
	 */
	function commentsTimeline($page = 1, $count = 50, $since_id = 0, $max_id = 0) {
		$params = array();
		if ($since_id) {
			$this->idFormat($since_id);
			$params['since_id'] = $since_id;
		...
		return $this->requestWithPager('comments/timeline', $page, $count, $params);
	}
	 ...
	 * @return array
	 */
	function commentsMentions($page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0) {
		$params = array();
		$params['since_id'] = $since_id;
		$params['max_id'] = $max_id;
		$params['count'] = $count;
	 ...
	 * @return array
	 */
	function commentsShowBatch($cids) {
		$params = array();
		if (is_array($cids) && !empty($cids)) {
			foreach ($cids as $k => $v) {
				$this->idFormat($cids[$k]);
			}
	 ...
	 * @return array
	 */
	function sendComment($id, $comment, $comment_ori = 0) {
		$params = array();
	 ...
	 * @return array
	 */
	function showUserByName($screen_name) {
		$params = array();
		$params['screen_name'] = $screen_name;
	 ...
	 * @return array
	 */
	function usersShowBatchById($uids) {
		$params = array();
		if (is_array($uids) && !empty($uids)) {
			foreach ($uids as $k => $v) {
				$this->idFormat($uids[$k]);
	 ...
	 * @return array
	 */
	function usersShowBatchByName($screen_name) {
		$params = array();
		if (is_array($screen_name) && !empty($screen_name)) {
			$params['screen_name'] = join(',', $screen_name);
		} else {
	 ...
	 * @return array
	 */
	function friendsById($uid, $cursor = 0, $count = 50) {
		$params = array();
	 ...
	 * @return array
	 */
	function friendsByName($screen_name, $cursor = 0, $count = 50) {
		$params = array();
		$params['cursor'] = $cursor;
		$params['count'] = $count;
		$params['screen_name'] = $screen_name;
	 ...
	 * @return array
	 */
	function friendsInCommon($uid, $suid = NULL, $page = 1, $count = 50) {
		$params = array();
		$params['uid'] = $uid;
		$params['suid'] = $suid;
		$params['count'] = $count;
	 ...
	 * @return array
	 **/
	function bilateralIds($uid, $page = 1, $count = 50, $sort = 0) {
		$params = array();
		$params['uid'] = $uid;
		$params['count'] = $count;
		$params['page'] = $page;
	 ...
	 * @return array
	 */
	function friendsIdsById($uid, $cursor = 0, $count = 500) {
		$params = array();
		$this->idFormat($uid);
		$params['uid'] = $uid;
		$params['cursor'] = $cursor;
	 ...
	 * @return array
	 */
	function friendsIdsByName($screen_name, $cursor = 0, $count = 500) {
		$params = array();
		$params['cursor'] = $cursor;
		$params['count'] = $count;
		$params['screen_name'] = $screen_name;
	 ...
	 * @return array
	 **/
	function friendsRemarkBatch($uids) {
		$params = array();
		if (is_array($uids) && !empty($uids)) {
			foreach ($uids as $k => $v) {
				$this->idFormat($uids[$k]);
	 ...
	 * @return array
	 **/
	function followersById($uid, $cursor = 0, $count = 50) {
		$params = array();
		$this->idFormat($uid);
		$params['uid'] = $uid;
		$params['count'] = $count;
	 ...
	 * @return array
	 **/
	function followersByName($screen_name, $cursor = 0, $count = 50) {
		$params = array();
		$params['screen_name'] = $screen_name;
		$params['count'] = $count;
		$params['cursor'] = $cursor;
	 ...
	 * @return array
	 **/
	function followersIdsById($uid, $cursor = 0, $count = 50) {
		$params = array();
		$this->idFormat($uid);
		$params['uid'] = $uid;
		$params['count'] = $count;
	 ...
	 * @return array
	 **/
	function followersIdsByName($screen_name, $cursor = 0, $count = 50) {
		$params = array();
		$params['screen_name'] = $screen_name;
		$params['count'] = $count;
		$params['cursor'] = $cursor;
	 ...
	 * @return array
	 **/
	function followersActive($uid, $count = 20) {
		$param = array();
		$this->idFormat($uid);
		$param['uid'] = $uid;
		$param['count'] = $count;
	 ...
	 * @return array
	 **/
	function friendsChainFollowers($uid, $page = 1, $count = 50) {
		$params = array();
		$this->idFormat($uid);
		$params['uid'] = $uid;
		$params['count'] = $count;
	 ...
	 * @return array
	 */
	function isFollowedById($target_id, $source_id = NULL) {
		$params = array();
		$this->idFormat($target_id);
		$params['target_id'] = $target_id;

		if ($source_id != NULL) {
			$this->idFormat($source_id);
	 ...
	 * @return array
	 */
	function isFollowedByName($target_name, $source_name = NULL) {
		$params = array();
	 ...
	 * @return array
	 */
	function followByName($screen_name) {
		$params = array();
		$params['screen_name'] = $screen_name;
		return $this->oauth->post('friendships/create', $params);
	}
	 ...
	 * @return array
	 */
	function followCreateBatch($uids) {
		$params = array();
		if (is_array($uids) && !empty($uids)) {
			foreach ($uids as $k => $v) {
				$this->idFormat($uids[$k]);
	 ...
	 * @return array
	 */
	function unfollowByName($screen_name) {
		$params = array();
		$params['screen_name'] = $screen_name;
		return $this->oauth->post('friendships/destroy', $params);
	}
	 ...
	 * @return array
	 */
	function listDm($page = 1, $count = 50, $since_id = 0, $max_id = 0) {
		$params = array();
		if ($since_id) {
			$this->idFormat($since_id);
			$params['since_id'] = $since_id;
		...
		return $this->requestWithPager('direct_messages', $page, $count, $params);
	}
	 ...
	 * @return array
	 */
	function listDmSent($page = 1, $count = 50, $since_id = 0, $max_id = 0) {
		$params = array();
		if ($since_id) {
			$this->idFormat($since_id);
			$params['since_id'] = $since_id;
		...
		return $this->requestWithPager('direct_messages/sent', $page, $count, $params);
	}
	 ...
	 * @return array
	 */
	function dmUserList($count = 20, $cursor = 0) {
		$params = array();
		$params['count'] = $count;
		$params['cursor'] = $cursor;
	 ...
	 * @return array
	 */
	function dmConversation($uid, $page = 1, $count = 50, $since_id = 0, $max_id = 0) {
		$params = array();
		$this->idFormat($uid);
		$params['uid'] = $uid;
		if ($since_id) {
	 ...
	 * @return array
	 */
	function sendDmById($uid, $text, $id = NULL) {
		$params = array();
		$this->idFormat($uid);
		$params['text'] = $text;
		$params['uid'] = $uid;
	 ...
	 * @return array
	 */
	function sendDmByName($screen_name, $text, $id = NULL) {
		$params = array();
		$params['text'] = $text;
		$params['screen_name'] = $screen_name;
		if ($id) {
	 ...
	 * @return array
	 */
	function deleteDms($dids) {
		$params = array();
		if (is_array($dids) && !empty($dids)) {
			foreach ($dids as $k => $v) {
				$this->idFormat($dids[$k]);
			}
	 ...
	 * @return array
	 */
	function accountProfileBasic($uid = NULL) {
		$params = array();
		if ($uid) {
			$this->idFormat($uid);
			$params['uid'] = $uid;
	 ...
	 * @return array
	 */
	function accountEducation($uid = NULL) {
		$params = array();
		if ($uid) {
			$this->idFormat($uid);
			$params['uid'] = $uid;
	 ...
	 * @return array
	 */
	function accountEducationBatch($uids) {
		$params = array();
		if (is_array($uids) && !empty($uids)) {
			foreach ($uids as $k => $v) {
				$this->idFormat($uids[$k]);
	 ...
	 * @return array
	 */
	function accountCareer($uid = NULL) {
		$params = array();
		if ($uid) {
			$this->idFormat($uid);
			$params['uid'] = $uid;
	 ...
	 * @return array
	 */
	function accountCareerBatch($uids) {
		$params = array();
		if (is_array($uids) && !empty($uids)) {
			foreach ($uids as $k => $v) {
				$this->idFormat($uids[$k]);
	 ...
	 * @return array
	 */
	function updateProfileImage($image_path) {
		$params = array();
	 ...
	 * @return array
	 */
	function updatePrivacy($privacy_settings) {
	 ...
	 * @return array
	 */
	function getFavorites($page = 1, $count = 50) {
		$params = array();
		$params['page'] = intval($page);
		$params['count'] = intval($count);
	 ...
	 * @return array
	 */
	function favoritesByTags($tid, $page = 1, $count = 50) {
		$params = array();
		$params['tid'] = $tid;
		$params['count'] = $count;
		$params['page'] = $page;
	 ...
	 * @return array
	 */
	function favoritesTags($page = 1, $count = 50) {
		$params = array();
		$params['count'] = $count;
		$params['page'] = $page;
	 ...
	 * @return array
	 */
	function removeFromFavoritesBatch($fids) {
		$params = array();
		if (is_array($fids) && !empty($fids)) {
			foreach ($fids as $k => $v) {
				$this->idFormat($fids[$k]);
			}
	 ...
	 * @return array
	 */
	function favoritesTagsUpdate($id, $tags) {
		$params = array();
		$params['id'] = $id;
		if (is_array($tags) && !empty($tags)) {
			foreach ($tags as $k => $v) {
				$this->idFormat($tags[$k]);
			}
	 ...
	 * @return array
	 */
	function favoritesUpdateBatch($tid, $tag) {
		$params = array();
		$params['tid'] = $tid;
		$params['tag'] = $tag;
	 ...
	 * @return array
	 */
	function favoritesTagsDestroyBatch($tid) {
		$params = array();
		$params['tid'] = $tid;
	 ...
	 * @return array
	 */
	function getTrends($uid = NULL, $page = 1, $count = 10) {
		$params = array();
		if ($uid) {
			$params['uid'] = $uid;
		} else {
			$user_info = $this->getUid();
			$params['uid'] = $user_info['uid'];
		}
		$this->idFormat($params['uid']);
		$params['page'] = $page;
		$params['count'] = $count;
	 ...
	 * @return array
	 */
	function trendsIsFollow($trend_name) {
		$params = array();
	 ...
	 * @return array
	 */
	function hourlyTrends($base_app = 0) {
		$params = array();
	 ...
	 * @return array
	 */
	function dailyTrends($base_app = 0) {
		$params = array();
		$params['base_app'] = $base_app;
	 ...
	 * @return array
	 */
	function weeklyTrends($base_app = 0) {
		$params = array();
		$params['base_app'] = $base_app;
	 ...
	 * @return array
	 */
	function followTrends($trend_name) {
		$params = array();
		$params['trend_name'] = $trend_name;
	 ...
	 * @return array
	 */
	function getTags($uid = NULL, $page = 1, $count = 20) {
		$params = array();
		if ($uid) {
			$params['uid'] = $uid;
		} else {
	 ...
	 * @return array
	 */
	function getSuggestTags($count = 10) {
		$params = array();
		$params['count'] = intval($count);
	 ...
	 * @return array
	 */
	function searchUsers($q, $count = 10) {
		$params = array();
		$params['q'] = $q;
		$params['count'] = $count;
	 ...
	 * @return array
	 */
	function searchStatuses($q, $count = 10) {
		$params = array();
		$params['q'] = $q;
		$params['count'] = $count;
	 ...
	 * @return array
	 */
	function searchSchools($q, $count = 10, $type = 1) {
		$params = array();
		$params['q'] = $q;
		$params['count'] = $count;
		$params['type'] = $type;
	 ...
	 * @return array
	 */
	function searchCompanies($q, $count = 10) {
		$params = array();
		$params['q'] = $q;
		$params['count'] = $count;
	 ...
	 * @return array
	 */
	function searchAtUsers($q, $count = 10, $type = 0, $range = 2) {
		$params = array();
		$params['q'] = $q;
		$params['count'] = $count;
		$params['type'] = $type;
	 ...
	 * @return array
	 */
	function searchStatusesHigh($query) {
	 ...
	 * @return array
	 */
	function searchUsersKeywords($query) {
	 ...
	 * @return array
	 */
	function hotUsers($category = "default") {
		$params = array();
	 ...
	 * @ignore
	 */
	function suggestionsMayInterested($page = 1, $count = 10) {
		$params = array();
		$params['page'] = $page;
		$params['count'] = $count;
	 ...
	 * @return array
	 */
	function suggestionsUsersByStatus($content, $num = 10) {
		$params = array();
	 ...
	 * @return array
	 */
	function hotFavorites($page = 1, $count = 20) {
		$params = array();
		$params['count'] = $count;
		$params['page'] = $page;
	 ...
	 * @return array
	 */
	function putUsersNotInterested($uid) {
		$params = array();
		$params['uid'] = $uid;
	 ...
	 * @ignore
	 */
	protected function requestWithPager($url, $page = false, $count = false, $params = array()) {
		if ($page) {
			$params['page'] = $page;
		}
	 ...
	 * @ignore
	 */
	protected function requestWithUid($url, $uid_or_name, $page = false, $count = false, $cursor = false, $post = false, $params = array()) {
		if ($page) {
			$params['page'] = $page;
		}
	 ...
	 * @ignore
	 */
	protected function idFormat(&$id) {
		if (is_float($id)) {
